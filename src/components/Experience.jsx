              ...
              {experiences.map((experience, index) => (
                ...
                >
                  <div className="flex flex-col sm:flex-row items-start">
                    ...
                    {/* Right: Description & technologies */}
                      ...
                      <div className="bg-white dark:bg-gray-800 p-5 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                        <ul className="space-y-2 list-none">
                          {experience.description.map((item, i) => (
                            <li
                              key={i}
                              className="text-gray-700 dark:text-gray-300 flex items-start text-sm leading-relaxed"
                            >
                              <span className="inline-block w-2 h-2 rounded-full bg-primary-500 dark:bg-primary-400 mt-2 mr-2 flex-shrink-0"></span>
                              {item}
                            </li>
                          ))}
                        </ul>
                        ...
                        <div className="mt-4 flex flex-wrap gap-2">
                          {experience.technologies.map((tech, i) => (
                            <span
                              key={i}
                              className="px-3 py-1 text-xs font-semibold rounded-full bg-primary-100 dark:bg-primary-900 text-primary-800 dark:text-primary-300 shadow-sm"
                            >
                              {tech}
                            </span>
                          ))}
